...
// vendored from reactbits.dev, MIT; light theme edits
...
const BorderGlow: React.FC<BorderGlowProps> = ({
    ...
    const borderOpacity = isHovered
        ...
        : 0;
    const glowOpacity = isHovered ? Math.max(0, (edgeProximity * 100 - edgeSensitivity) / (100 - edgeSensitivity)) : 0;
