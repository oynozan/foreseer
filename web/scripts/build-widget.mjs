// Builds data/example.json from the golden vectors, then bundles the widget.
// Run: packages/ts/node_modules/.bin/tsx web/scripts/build-widget.mjs
...
await esbuild.build({
    entryPoints: [join(here, "..", "widget", "widget-entry.mjs")],
    bundle: true,
    format: "iife",
    outfile: join(here, "..", "public", "foreseer-widget.js"),
    minify: true,
    target: "es2022",
    logLevel: "info",
});
